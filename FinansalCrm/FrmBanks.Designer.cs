namespace FinansalCrm
{
	partial class FrmBanks
	{
		...
		private void InitializeComponent()
		{
			...
			resources.ApplyResources(this.btnBillForm, "btnBillForm");
			...
			// 
			resources.ApplyResources(this.lblZiraatBankBalance, "lblZiraatBankBalance");
			this.lblZiraatBankBalance.ForeColor = System.Drawing.Color.Snow;
			...
			// lblVakıfBankBalance
			// 
			resources.ApplyResources(this.lblVakıfBankBalance, "lblVakıfBankBalance");
			this.lblVakıfBankBalance.ForeColor = System.Drawing.Color.Snow;
			...
			// lblIsBankBalance
			// 
			resources.ApplyResources(this.lblIsBankBalance, "lblIsBankBalance");
			this.lblIsBankBalance.ForeColor = System.Drawing.Color.Snow;
			...
			// lblBankProcess5
			// 
			resources.ApplyResources(this.lblBankProcess5, "lblBankProcess5");
			...
			// lblBankProcess4
			// 
			resources.ApplyResources(this.lblBankProcess4, "lblBankProcess4");
			...
			// lblBankProcess3
			// 
			resources.ApplyResources(this.lblBankProcess3, "lblBankProcess3");
			...
			// lblBankProcess2
			// 
			resources.ApplyResources(this.lblBankProcess2, "lblBankProcess2");
			...
			// lblBankProcess1
			// 
			resources.ApplyResources(this.lblBankProcess1, "lblBankProcess1");
