namespace FinansalCrm
{
	partial class FrmBilling
	{
		...
		private void InitializeComponent()
		{
			...
			this.panel1.Controls.Add(this.btnBanksForms);
			...
			// btnBanksForms
			// 
			this.btnBanksForms.BackColor = System.Drawing.Color.MidnightBlue;
			resources.ApplyResources(this.btnBanksForms, "btnBanksForms");
			this.btnBanksForms.ForeColor = System.Drawing.Color.White;
			this.btnBanksForms.Name = "btnBanksForms";
			this.btnBanksForms.UseVisualStyleBackColor = false;
			this.btnBanksForms.Click += new System.EventHandler(this.btnBanksForms_Click);
			// 
			// btn
			// 
			...
			resources.ApplyResources(this.txtBillPeriod, "txtBillPeriod");
			this.txtBillPeriod.ForeColor = System.Drawing.SystemColors.MenuText;
		...
		private System.Windows.Forms.Button btnBanksForms;
